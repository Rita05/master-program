...
class CommercialBank:
    def __init__(self):
        ...
        # self.k = 0.15  # 0.1-0.3
        # self.k = 0.6514065
        # self.k = 0.535451862980144
        # self.k = 0.2
        # self.k = 0.387449311595
        # self.k = 0.39
        self.k = 0.2
    ...
    def display_info_(self):
        ...
        print("__________________________________________________")
        print(f"Коэффициент корректировки затрат на рекламуы банка L = {self.L}")
        print(f"Степень влияния процентной ставки по кредиту на рекламные расходы delta = {self.delta}")
        print(f"Коэффициент кредитоспособности ИП k = {self.k}")
    ...
    def risk_costs(self, pr, m, entrepreneur: Entrepreneur):
        alpha = entrepreneur.alpha
        return entrepreneur.C * (1 + pr) * m * self.k
    ...
    def object_function(self, pr, m, entrepreneur: Entrepreneur):
        ...
        # return credit_income - credit_risk_costs - advertising_costs
