...
class Entrepreneur:
    def __init__(self, config: ConfigImitation):
        ...
        # self.alpha = 0.2984
        # self.alpha = 0.5793201927141789
        # self.alpha = 0.5434844667
        # self.alpha = 0.54
        self.alpha = 0.7
        self.alpha = config.alpha
        #Коэффициент эластичности по кредиту на закупку товара betta
        # self.betta = 0.4# 0.35-0.5 не включая 0.5
        # self.betta = 0.589739551
        # self.betta = 0.6495490545644979
        # self.betta = 0.384640342864
        # self.betta = 0.39
        self.betta = 0.35
        self.betta = config.betta
    ...
    def display_info_(self):
        ...
        print(f"Парамерт корреляции кредитного долга на процентную ставку C = {self.C}")
    ...
    def storage_costs(self, pr, markup):
        quantity_goods = self.compute_quantity_goods(pr)
        return self.D * (markup ** self.gamma) * quantity_goods * (1+pr)
